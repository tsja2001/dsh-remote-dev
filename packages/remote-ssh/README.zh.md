...
完整使用说明、安全模型、Windows 指南与本地测试方法请阅读仓库的[中文 README](https://github.com/tsja2001/dsh-remote-ssh/blob/main/README.zh.md)。

本项目采用 [MIT License](https://github.com/tsja2001/dsh-remote-ssh/blob/main/LICENSE)，是社区维护插件，并非 DeepSeek AI 官方产品。
